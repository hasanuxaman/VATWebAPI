...
{
    [RoutePrefix("api/Purchases"), Authorize]
    public class PurchasesController : ApiController
    {
        ...
        public RequestResult Import(PurchaseList vms)
        {
            ...
            try
            {
                ...
                if (vms.Invoices != null)
                {
                    ...
                    PurchasesModel _vm = new PurchasesModel();
              ...
              .ToList();
                    ...
                    {
                        PurchasesRepo Repo = new PurchasesRepo(_mapper);
                        user.BIN = vms.Invoices.FirstOrDefault().Invoice.BIN;

                        APIUtilities.Login(user);

                         dataTable = APIUtilities.PurchaseConvertToDataTable(vms.Invoices);
