...
{
    [RoutePrefix("api/Sales"), Authorize]
    public class SalesController : ApiController
    {
        ...
        public RequestResult Import(SalesList vms)
        {
            ...
            try
            {
              ...
              .ToList();
                    ...
                    {
                        SalesRepo Repo = new SalesRepo(_mapper);
                        user.BIN = vms.Invoices.FirstOrDefault().Invoice.BIN;

                        //user.BIN = vms.Invoices.FirstOrDefault().CompanyCode;
                        APIUtilities.Login(user);
                         dataTable = APIUtilities.SalesConvertToDataTable(vms.Invoices);
